...
public class UserController {
	...
	@RequestMapping(value = "/api/users/{uid}/wallets/{wid}/balance", method = RequestMethod.GET, produces = "application/json")
	...
	@RequestMapping(value = "/api/users/{uid}/wallets/{wid}/topup", method = RequestMethod.PUT, produces = "application/json")
